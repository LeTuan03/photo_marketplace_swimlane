...
| **License & tra cứu** | Mỗi license có **phạm vi được/không được dùng rõ ràng** (hiện ở chi tiết ảnh + bắt cam kết khi thanh toán); **trang tra cứu công khai `/verify`** theo `certNo` (loại license, phạm vi, người giữ che một phần, còn hiệu lực/đã thu hồi); **báo cáo dùng sai phạm vi** → admin xử lý tại `/admin/misuse`, xác nhận vi phạm thì **+điểm phạt người giữ license** |
